...
function About() {
  return (
                <div class="container px-32 mx-auto flex my-36 bg-slate-900">
                        ...
                        <div class="grid grid-cols-2 gap-24">
                            <div>
                                <section class="gyIMjU section__content-about">
                                    ...
                                    <p>
                                    With 1.5 years of experience in web development, I have a deep understanding of the latest web technologies and design principles. 
