...
function Contact() {
  return (
        <div>
                ...
                <footer class="grid grid-cols-2 gap-24 px-48 py-20 bg-gradient-to-b from-slate-800 to-slate-900 dark:bg-gray-900">
         ...
         <div class="button">
            ...
            <span><a href='https://www.linkedin.com/in/jihad-oulad-9791b4185/' target="_blank" rel='noreferrer'>Linkedin</a></span>
         </div>
         ...
         <div class="button">
            ...
            <span><a href='https://github.com/jihadoulad' target="_blank" rel='noreferrer'>Github</a></span>
         </div>
         </div>
